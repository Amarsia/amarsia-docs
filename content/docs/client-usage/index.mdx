...
<Cards>
  <Card title="JavaScript SDK" href="/client-usage/javascript" description="Install and use the official JavaScript/TypeScript SDK." />
  <Card title="Error Handling" href="/client-usage/error-handling" description="Handle errors and retries reliably in your integration." />
</Cards>
