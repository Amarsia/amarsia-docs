...
[
  ...
  },
  {
    ...
    "created_at": "2026-05-28T09:32:14.919855"
  }
]
```
...
```tsx
const { conversation, conversations, conversationsPageInfo } = useConversation(client)
...
```bash
curl "https://api.amarsia.com/v1/runner/YOUR_DEPLOYMENT_ID/conversations?page=1&page_size=20&userId=user_123&channel=web-chat" \
  -H "x-api-key: YOUR_API_KEY"
```
